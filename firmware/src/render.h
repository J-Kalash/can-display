...
public:
    ...
    virtual void CopyRectangleAndBlendBackground(const void* source, uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint32_t color) = 0;
...
public:
    ...
    void FillRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t color);
    void CopyRectangleAndBlendBackground(const void* source, uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint32_t color);
private:
